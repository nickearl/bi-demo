		...
		self.layout = {
			...
			'chatbot': dbc.Card([
				dbc.Stack([
					html.H3('Chatbot'),
					dbc.Stack([
						html.Img(src='assets/images/ai_interview.png',className='home-panel-feature'),
						html.Span('A chat agent that can answer questions about my work and experience',className='home-panel-feature',style={'font-size':'1.1rem'}),
					],direction='horizontal',gap=3),
				],gap=1, className='d-flex align-items-center justify-content-center p-2',style={'color':'black','min-width':'275px'}),
			]),
